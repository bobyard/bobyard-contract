...
module bob::bobyard_tests {
    use bob::bobYard::{Self, init_market, Market, init_list, add_item_to_list, add_listing_to_market, Listing, buy_one, rem_listing_from_market, sweep, init_offer, add_offer_to_market, rem_offer_from_market, take_market_fee, change_listing_price_and_time};
    ...
    #[test]
    #[expected_failure(abort_code = bobYard::EBuyerCanBeSeller)]
    ...
    #[test]
    #[expected_failure(abort_code = bobYard::EAmountIncorrect)]
    ...
    #[test]
    #[expected_failure(abort_code = bobYard::EExpired)]
